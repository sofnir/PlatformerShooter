...
int main()
{
	...
	KeyboardController firstPlayerController(0);
	std::cout << "First player: " << firstPlayerController.getControllerType() << "\n";
	...
	KeyboardController secondPlayerController(1);
	std::cout << "Second player: " << firstPlayerController.getControllerType() << "\n";
